...
const SmallGllery = () => {
    const fakesmalGallary = [
        { img: 'https://premiumlayers.com/new/museum/wp-content/uploads/2015/09/img-7.jpg', title: `ANCIENT STATUES COLLECTIONS`, location: `ORGIN: Naples, Italy` },
        { img: img1, title: `DINOSAURS SKELETON`, location: `ORGIN: South Africa, Africa` },
        { img: 'https://premiumlayers.com/new/museum/wp-content/uploads/2015/09/img-4.jpg', title: `MODERN ART COLLECTIONS`, location: `ORGIN: New York, USA` },
    ]
    return (
